...
<div class="max-w-7xl mx-auto space-y-4">
    <flux:heading size="xl" class="text-zinc-800 dark:text-white">HELLO KING</flux:heading>
    <flux:subheading size="lg" class="text-zinc-600 dark:text-zinc-400">Welcome to your king page.</flux:subheading>
